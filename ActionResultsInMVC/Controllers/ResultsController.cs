...
namespace ActionResultsInMVC.Controllers
{
    public class ResultsController : Controller
    {
       ...
       public JsonResult GetEmployees()
        ...
        {
            return File("~/Downloads/2024062773 (1).pdf", "application/pdf");
        }
        public FileResult DownloadWord()
        {
            return File("~/Downloads/DownloadWord.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
        }
        ...
        public ActionResult SendDate2()   // ActionResult or ContentResult as well
        {
